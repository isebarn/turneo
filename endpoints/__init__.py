...
private_group_reference = api.model('private_group_reference', models.PrivateGroup.reference())
...
class ExperienceController(Resource):
    ...
    def post(self):
        return models.Experience(**request.get_json()).to_json()

    # @api.marshal_with(api.models.get('experience'), skip_none=True)
    def put(self):
        data = models.Experience.update(**request.get_json())
        return data.to_json()

    # @api.marshal_with(api.models.get('experience'), skip_none=True)
    def patch(self):
        return models.Experience.set(**request.get_json()).to_json()
...
class RatesController(Resource):
    ...
    def post(self):
        return models.Rates(**request.get_json()).to_json()

    # @api.marshal_with(api.models.get('rates'), skip_none=True)
    def put(self):
        data = models.Rates.update(**request.get_json())
        return data.to_json()

    # @api.marshal_with(api.models.get('rates'), skip_none=True)
    def patch(self):
        return models.Rates.set(**request.get_json()).to_json()
